...
public class ResponseCatalog {
    ...
    public ResponseCatalog(Long id, Integer response_option, String response_text, Catalog catalog, Question question,
            Response response) {
        this.id = id;
    ...
    public String toString() {
        return "ResponseCatalog [id=" + id + ", response_option=" + response_option + ", response_text=" + response_text
                + ", catalog=" + catalog + ", question=" + question + ", response=" + response + "]";
    }
